...
| Amadeus·低价日历(国际+补全) | ✅ 可用(需免费 Key) | developer.amadeus.com 注册 Self-Service,用 /v1/shopping/flight-dates/cheapest 查含税最低价;国际线路全量使用,国内线路缺价日自动补洞(缓存24h) |
...
- [x] **v0.8 缺价补全+Skyscanner式UI+移动提醒**: 临近日参考价补全(7天紧/45天远二级半径+距离标注,日历 60/60 无空洞)、v0.8 设计系统(Skyscanner 配色/城市图鉴 Hero/低价柱状图视图/日历柱状一键切换)、移动端浮动低价提醒横幅+震动+系统通知授权按钮
- [ ] **v0.9 拓展**:多源比价(航司官网/携程 H5)、多旅客、价格预测(历史序列)、微信推送模板优化
