...
- 🌍 **国际航线(Amadeus)**:线路勾选"国际航线"并填 IATA 三字码(如 HGH→NRT),走 Amadeus 低价日历接口,返回含税总价;免费注册 Self-Service 即可用
...
Web 仪表盘(v0.6 起为浅色主题,移动端自适应,iPhone 可"添加到主屏幕"当 App 用):
...
- [ ] **v0.7 拓展**:多源比价(航司官网/携程 H5, 补航班起降时刻)、多旅客、价格预测(历史序列)、微信推送模板优化
